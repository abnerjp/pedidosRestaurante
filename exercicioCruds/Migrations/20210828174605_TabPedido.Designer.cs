...
namespace exercicioCruds.Migrations
{
    ...
    [Migration("20210828174605_TabPedido")]
    partial class TabPedido
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("exercicioCruds.Models.Pedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("exercicioCruds.Models.Pedido", b =>
                {
                    b.HasOne("exercicioCruds.Models.Produto", "Produto")
                        .WithMany()
                        .HasForeignKey("ProdutoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("exercicioCruds.Models.Restaurante", "Restaurante")
                        .WithMany()
